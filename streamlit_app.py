...
if twelve_hour_shift_option == 'No':
    days_remaining_eight_hour_shift = round(remaining_pto_days - days_to_use, 2)
    hours_remaining_eight_hour_shift = round((remaining_pto_hours) - (days_to_use * 8) ,2 )

    output = st.write("You have " + str(days_remaining_eight_hour_shift) + " days and " + str(hours_remaining_eight_hour_shift) + " hours remaining")

else:        
# if days_or_hours == 'Days' and twelve_hour_shift_option == 'Yes':
    days_remaining_twelve_hour_shift = round(remaining_pto_days - days_to_use, 2)
    hours_remaining_twelve_hour_shift = round((remaining_pto_hours) - (days_to_use * 12) ,2 )

    output = st.write("You have " + str(days_remaining_twelve_hour_shift) + " days and " + str(hours_remaining_twelve_hour_shift) + " hours remaining")
